...
exports.addFlagsToPost = exports.revokeAuthorPrivilleges = exports.grantAuthorPrivilleges = void 0;
const User_1 = __importDefault(require("../models/User"));
const genericMailSender_1 = require("../utils/genericMailSender");
const env_1 = require("../config/env");
const Post_1 = __importDefault(require("../models/Post"));
// grant write privilleges to author
const grantAuthorPrivilleges = async (req, res) => {
    try {
...
`,
        ...
        res.success(200, "success", `Author privilleges granted to ${user.fullname}`, null);
        return;
    }
    catch (error) {
...
exports.grantAuthorPrivilleges = grantAuthorPrivilleges;
// revoke author privilleges
const revokeAuthorPrivilleges = async (req, res) => {
    try {
        const id = req.params.id;
        const user = await User_1.default.findById(id);
        if (!user) {
...
`,
        ...
        res.success(200, "success", `Author privilleges revoked from ${user.fullname}`, null);
        return;
    }
    catch (error) {
        res.error(500, "error", "Something went wrong", error);
...
exports.revokeAuthorPrivilleges = revokeAuthorPrivilleges;
const addFlagsToPost = async (req, res) => {
    try {
...
exports.addFlagsToPost = addFlagsToPost;
